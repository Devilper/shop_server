...
class UserStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateUsr = channel.unary_unary(
            '/User/UpdateUsr',
...
class UserServicer(object):
    ...
    def UpdateUsr(self, request, context):
        """更新用户
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_UserServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'UpdateUsr': grpc.unary_unary_rpc_method_handler(
            servicer.UpdateUsr,
...
class User(object):
    ...
    def UpdateUsr(request,
                  ...
                  timeout=None,
                  metadata=None):
        return grpc.experimental.unary_unary(request, target, '/User/UpdateUsr',
